...
public class Activity_location_picker extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Autocomplete.IntentBuilder(
                        ...
                        .build(Activity_location_picker.this);
                Activity_location_picker.this.startActivityForResult(intent, PLACE_AUTOCOMPLETE_REQUEST_CODE);
            }
        });
        ...
        txtSelectLocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Activity_location_picker.this.setResult(Activity.RESULT_OK, intent);
                Activity_location_picker.this.finish();
            }
        });
        ...
        imgCurrentloc.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Activity_location_picker.this.showCurrentLocationOnMap(false);
        ...
        directionTool.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Activity_location_picker.this.showCurrentLocationOnMap(true);
        ...
        googleMapTool.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Activity_location_picker.this.startActivity(intent);
            }
        });
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == PLACE_AUTOCOMPLETE_REQUEST_CODE) {
            ...
            if (resultCode != RESULT_OK) {
                ...
                Toast.makeText(Activity_location_picker.this, "Location Not Available..", Toast.LENGTH_SHORT).show();
                ...
                public void onSuccess(Location location) {
                    if (location != null) {
                        ...
                        if (isDirectionClicked) {
                            ...
                            Activity_location_picker.this.getAddressByGeoCodingLatLng();
                        }

                    } else {
                        //Gps not enabled if loc is null
                        Activity_location_picker.this.getSettingsLocation();
                        Toast.makeText(Activity_location_picker.this, "Location not Available", Toast.LENGTH_SHORT).show();
...
//                getSettingsLocation();
                    Toast.makeText(Activity_location_picker.this, "Location Not Availabe", Toast.LENGTH_SHORT).show();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.setOnMapClickListener(new GoogleMap.OnMapClickListener() {
            ...
            public void onMapClick(LatLng latLng) {
                ...
                Log.e("latlng", latLng + "");
                isZooming=true;
                Activity_location_picker.this.addMarker();
                if (!MapUtility.isNetworkAvailable(Activity_location_picker.this)) {
                    MapUtility.showToast(Activity_location_picker.this, "Please Connect to Internet");
                }
                Activity_location_picker.this.getAddressByGeoCodingLatLng();
            ...
            public void onComplete(@NonNull Task<LocationSettingsResponse> task) {
                try {
                    ...
                    if (response != null) {
                        ...
                        Activity_location_picker.this.startLocationUpdates();
    ...
    private class GetAddressFromLatLng extends AsyncTask<Double, Void, Bundle> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            MapUtility.showProgress(Activity_location_picker.this);
        }
        ...
        protected Bundle doInBackground(Double... doubles) {
            try {
                ...
                geocoder = new Geocoder(Activity_location_picker.this, Locale.getDefault());
        ...
        protected void onPostExecute(Bundle userAddress) {
            ...
            Activity_location_picker.this.userAddress = userAddress.getString("fulladdress");
            Activity_location_picker.this.userCity = userAddress.getString("city");
            Activity_location_picker.this.userState = userAddress.getString("state");
            Activity_location_picker.this.userPostalCode = userAddress.getString("postalcode");
            Activity_location_picker.this.userCountry = userAddress.getString("country");
            Activity_location_picker.this.userAddressline2 = userAddress.getString("addressline2");
            MapUtility.hideProgress();
            addMarker();
        }
    }
    ...
    private class GetLatLngFromAddress extends AsyncTask<String, Void, LatLng> {
        ...
        protected void onPostExecute(LatLng latLng) {
            ...
            Activity_location_picker.this.mLatitude = latLng.latitude;
            Activity_location_picker.this.mLongitude = latLng.longitude;
            MapUtility.hideProgress();
            addMarker();
        }
    }
